        ...
        <div className="flex items-center justify-center p-4">
            <div className="relative w-full max-w-md bg-white p-8 rounded-xl shadow-2xl space-y-6 border border-gray-200">
                ...
                <form onSubmit={submit} className="space-y-4">
                    <InputField id="name" name="name" placeholder="Name" required value={user.name} />
                    <InputField id="username" name="username" placeholder="Username" required value={user.username} />
